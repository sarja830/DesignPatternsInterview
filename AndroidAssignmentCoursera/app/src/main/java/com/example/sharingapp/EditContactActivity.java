...
public class EditContactActivity extends AppCompatActivity {
    ...
    public void saveContact(View view) {
        ...
        Command editContactCommand = new EditContactCommand(contact_list,contact,updated_contact,context);
    ...
    public void deleteContact(View view) {
        ...
        Command delete_contact_command = new DeleteContactCommand(contact_list,contact,context);
