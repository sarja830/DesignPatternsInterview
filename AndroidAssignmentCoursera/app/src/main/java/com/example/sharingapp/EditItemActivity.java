...
public class EditItemActivity extends AppCompatActivity{
    ...
    public void deleteItem(View view) {
        // Delete item
        DeleteItemCommand delete_item_command = new DeleteItemCommand(item, item_list, context);
    ...
    public void saveItem(View view) {
       ...
       Command editItemCommand = new EditItemCommand(item_list,item,updated_item,context);
        editItemCommand.execute();

        boolean success = editItemCommand.isExecuted();
        if (!success){
            return;
        }
